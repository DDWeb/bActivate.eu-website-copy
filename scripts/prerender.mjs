...
const ROUTE_SCHEMAS = {
  ...
  '/how-to-use': {
    ...
    'step': [
      { '@type': 'HowToStep', 'position': 1, 'name': 'Obtain pre-activation culture', 'text': 'Obtain a pre-activation uterine culture sample using a swab, a low-volume lavage or a biopsy (lavage or biopsy improve diagnostic sensitivity and specificity). Perform when the mare is in early oestrus (largest follicle 25-30 mm).' },
...
const PAGE_META = {
  ...
  '/blog/mare-absorbed-early-pregnancy-loss-signs-causes': {
    ...
    description: 'Vesicle gone on the next scan? How to recognise early embryonic loss in the mare, what causes it, and what the vet should check before she is covered again.',
  },
  '/blog/mare-not-getting-in-foal-what-to-do': {
