        ...
        <section style={{ background: '#f8f8f8', borderTop: '1px solid #e5e7eb', padding: '3rem 1rem' }}>
            <div style={{ maxWidth: '860px', margin: '0 auto' }}>
                ...
                <ul className="tldr" style={{ listStyle: 'none', padding: '1rem 1.25rem', margin: 0 }}>
                    ...
                    <li style={{ marginBottom: '0.9rem' }}><strong>Availability and price.</strong> Prescription veterinary product. 229 EUR per vial (about 265 USD at the current exchange rate, charged in EUR) from the manufacturer's online shop, or through Hagyard Pharmacy and Midwest Veterinary Supply at their own prices. Order on the <Link to="/shop">shop</Link> page or through <Link to="/our-distributors">our distributors</Link>.</li>
