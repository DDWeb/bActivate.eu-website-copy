        ...
        <section style={{ background: '#fff', padding: '2rem 1rem 0' }}>
            <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
                ...
                <ul className="tldr" style={{ listStyle: 'none', padding: '1rem 1.25rem', margin: 0 }}>
                    ...
                    <li><strong>How it is used.</strong> 10 ml instilled by your veterinarian in early oestrus, culture after 48 hours, treatment on the antibiogram, breeding in the following cycle. Prescription veterinary product, 229 EUR per vial, minimum online order 2 vials. <Link to="/how-to-use">The protocol</Link>.</li>
                </ul>
            </div>
        </section>
    );
