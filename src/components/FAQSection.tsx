...
export const homeFaqItems = [
  ...
  },
  {
    ...
    answer: "臨床シリーズでは、不受胎牝馬の47〜87%に、標準的なスワブでは見逃されていた休眠細菌による隠れた子宮内感染が見つかっています。これらの細菌は代謝の低い「パーシスター（persister）」状態に入り、標準的な子宮培養をすり抜け、抗菌薬に対して寛容（薬剤寛容）になります。標準的なスワブ細菌培養の検出感度は約34%にすぎず、こうした感染の多くを見逃します。bActivateは細菌を再活性化するので、獣医師が正確に診断し治療できるようになります。",
  },
  {
