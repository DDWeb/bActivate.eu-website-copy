...
export default function Contact() {
    ...
    return (
        <main>
                ...
                <div className="container mx-auto px-4 max-w-4xl">
                    ...
                    <div className="grid md:grid-cols-3 gap-6 mb-12">
                        <div className="border border-gray-200 p-6 rounded">
                            ...
                            <p className="text-gray-600 text-sm">bActivate is available in the US through Hagyard Pharmacy (Lexington, KY) and Midwest Veterinary Supply, or order online in the <a href="/shop" className="text-primary underline">shop</a>. See all options on the <a href="/our-distributors" className="text-primary underline">distributor page</a>.</p>
                        </div>
                        <div className="border border-gray-200 p-6 rounded">
            ...
            <InternalLinks links={[
                { to: '/shop', label: 'Order bActivate', description: '229 EUR per vial online (about 265 USD), or through US distributors' },
