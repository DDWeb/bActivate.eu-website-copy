        ...
        <div className={styles.container}>
          <div className={styles.featureGridTwoImagesReversed}>
            <div className={styles.featureTextSide}>
              ...
              <p className={styles.description}>
                bActivate is to be used in mares with reduced <a href="/glossary#uterine-defence-mechanisms">uterine defence mechanisms</a> (the uterus's own ability to clear bacteria and fluid after breeding) and in mares suspected of having a chronic subclinical infection.
              </p>
              <Link to="/how-to-use" className={styles.btnRedSquare}>
