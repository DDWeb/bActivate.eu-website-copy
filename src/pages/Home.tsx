          ...
          <div className={styles.heroFlex}>
            <div className={styles.heroText}>
              ...
              <p className={styles.heroSubtitle}>
                標準的なスワブは感染牝馬の約34%しか検出しません（Nielsen 2005）。公表された活性化シリーズでは、不受胎牝馬の47〜87%に隠れた子宮内感染が見つかっています。bActivateは、標準的な検査では見逃される休眠感染を活性化するので、獣医師がそれを治療し、不妊の牝馬に二度目のチャンスを与えることができます。
              </p>
            </div>
