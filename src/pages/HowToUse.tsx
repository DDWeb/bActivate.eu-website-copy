            ...
            <section className={styles.section}>
                <div className={styles.container}>
                    ...
                    <div className={styles.textBlock}>
                        ...
                        <p className="mb-4"><a href="https://pubmed.ncbi.nlm.nih.gov/?term=Petersen+Streptococcus+equi+zooepidemicus+endometrium+mares+2009" target="_blank" rel="noopener noreferrer">Petersen, M. R., Nielsen, J. M., Lehn-Jensen, H. and Bojesen, A. M. (2009). Streptococcus equi subspecies zooepidemicus resides deep in the chronically infected endometrium of mares, Clinical Theriogenology 1, 393-409.</a><br /><a href="https://doi.org/10.1016/j.vetmic.2015.06.006" target="_blank" rel="noopener noreferrer">Petersen, M. R., Lu, K., Christoffersen, M., Nielsen, J. M., Troedsson, M.H.T. and Bojesen, A. M (2013). Impact of activation and subsequent antimicrobial treatment of dormant endometrial streptococci in the Thoroughbre problem mare – a descriptive field study, Abstract and Poster, Society for Theriogenology Annual Meeting, Louisville, Kentucky</a></p>
