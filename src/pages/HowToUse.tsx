...
export default function HowToUse() {
    ...
    return (
        <main>
                ...
                <div className={styles.container}>
                    <div className={styles.grid}>
                        <div>
                            ...
                            <InShort>Culture the mare in early estrus (largest follicle 25 to 30 mm), instill 10 ml bActivate, culture again after 48 hours, and treat according to the antibiogram if the second culture grows what the first did not. Do not breed in that cycle; breed in the following one. bActivate is a diagnostic growth medium, not a medicine: it makes dormant <em>Streptococcus zooepidemicus</em> grow so a normal culture can find it. The full protocol and references are below.</InShort>
            ...
            <InternalLinks links={[
                { to: '/blog/bactivate-antibiotics-a-smarter-approach-to-treating-endometritis-in-mares', label: 'Why antibiotics fail on dormant bacteria', description: 'The culture has to come before the antibiotic' },
