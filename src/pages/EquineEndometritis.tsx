                ...
                <div className="container mx-auto px-4 max-w-4xl">
                    ...
                    <div className="overflow-x-auto mb-6">
                        <table className="w-full border-collapse text-sm">
                            ...
                            <tbody>
                                <tr className="border-b border-gray-200"><td className="p-3 font-bold">Ultrasound</td><td className="p-3">Fluid, oedema, cysts</td><td className="p-3">Does not identify the organism</td></tr>
