                    ...
                    <div className={styles.grid}>
                        ...
                        <div>
                            ...
                            <div className="text-gray-600 space-y-4">
                                <p>Some mares, often called non-pregnant mares, problem mares, or barren mares, struggle to get in foal season after season. Recent investigations have demonstrated that dormant bacterial infections in the uterus are a major cause. Dormant bacteria are difficult to diagnose by standard techniques and highly tolerant to antibiotics. Efficient handling requires re-activation of the bacteria, achieved by instillation of bActivate, a bacterial growth medium, into the uterus.</p>
                                <p>bActivate has been tested by the therio group at <strong>Hagyard Equine Medical Institute</strong>, the world’s largest equine hospital in Kentucky, which included bActivate in its standard reproductive work-up for problem mares and reported an 83% pregnancy rate in 64 such mares.</p>
                                <p>This scenario is familiar across breeding operations worldwide: a mare with a clean culture that still will not conceive. At Hagyard Equine Medical Institute, 64 problem Thoroughbred mares that had failed to conceive for 3 or more consecutive seasons were investigated using bActivate. <strong>83% became pregnant</strong> (53 of 64), and of those with confirmed foaling outcomes, <strong>70% delivered live foals</strong>. For these mares, the infection standard diagnostics had missed was found, treated by the attending veterinarian, and the mares were bred. No placebo group was included.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className={`${styles.section} bg-gray-50`}>
                <div className={styles.container}>
                    <div className="max-w-3xl mx-auto">
                        ...
                        <p className="text-gray-600">Clinical validation was led independently by Dr. Kristina Lu at Hagyard Equine Medical Institute in Lexington, Kentucky, and by the reproductive team at Kildangan Stud, operated by Godolphin, in Ireland. The laboratory mechanism was published in <em>Veterinary Microbiology</em> (<a href='https://doi.org/10.1016/j.vetmic.2015.06.006' target='_blank' rel='noopener noreferrer'>Petersen et al., 2015, DOI: 10.1016/j.vetmic.2015.06.006</a>). Bojesen and Petersen Biotech ApS was founded in Copenhagen in 2013.</p>
                    </div>
                </div>
            </section>
