        ...
        <main>
            <section className="py-16">
                <div className="container mx-auto px-4 max-w-4xl">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-4">The mechanism was shown in a placebo-controlled study (<a href='https://doi.org/10.1016/j.vetmic.2015.06.006' target='_blank' rel='noopener noreferrer'>Petersen et al., Veterinary Microbiology, 2015</a>): 64% activation versus 8% in the control group. In the field, among old repeatedly barren mares averaging 12.7 years and 6.3 barren cycles, 89% of the mares bred became pregnant in our own Kildangan Stud series. That is exactly the mare a conservation program is left with.</p>
                    <p className="text-gray-500 text-sm mb-10">Sources: Petersen MR et al., Veterinary Microbiology 2015;179:119-125, DOI 10.1016/j.vetmic.2015.06.006, <a href="https://www.researchgate.net/publication/279630136_Activation_of_persistent_Streptococcus_equi_subspecies_zooepidemicus_in_mares_with_subclinical_endometritis" target="_blank" rel="noopener noreferrer" className="underline">full text on ResearchGate</a> (placebo-controlled activation study). Kildangan Stud figures reported by the founders as a congress abstract, Journal of Equine Veterinary Science 2018;66:117, DOI 10.1016/j.jevs.2018.05.162; no placebo group was included.</p>
                    ...
                    <div className="space-y-5 mb-12">
                        <div>
                            ...
                            <p className="text-gray-700 leading-relaxed">The bActivate itself is donated. If your mare qualifies, your veterinarian receives a coupon and places the order in the <a href="/shop" className="text-primary underline">bactivate.us shop</a>, and only the shipping is paid. Your own veterinarian's normal fees still apply.</p>
                        </div>
                        <div>
