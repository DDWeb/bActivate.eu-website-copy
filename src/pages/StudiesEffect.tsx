                ...
                <div className={styles.container}>
                    ...
                    <div style={{ margin: "3rem 0", padding: "2.5rem", background: "#f8f8f8", borderLeft: "4px solid #901820" }}>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "1.5rem" }}>
                            ...
                            <a href="https://www.intechopen.com/chapters/50058" target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none", color: "inherit", display: "block", background: "white", padding: "1.5rem", borderBottom: "3px solid #901820" }}>
                                <div style={{ fontSize: "0.75rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: "1px", color: "#901820", marginBottom: "0.75rem" }}>IntechOpen, peer-reviewed chapter, 2016</div>
                                <blockquote style={{ fontStyle: "italic", color: "#333", lineHeight: 1.7, margin: "0 0 1rem", fontSize: "0.9rem" }}>"The activation of dormant bacteria, using bacterial growth mediums like bActivate, may improve significantly the sensitivity of traditional diagnostics."</blockquote>
                                <div style={{ fontSize: "0.8rem", color: "#666" }}>, Pasolini, Del Prete, Fabbri &amp; Auletta<br />DOI 10.5772/63741</div>
                            </a>
